 ...
 */
public class CaesiumOreGeneration implements IWorldGenerator {
    @Override
    ...
    private void generateSurface(World world, Random random, int chunkX,int chunkZ)
    {
        for(int K = 0; K < 8; K++){
            ...
            int Ycoords = random.nextInt(28);
            int Zcoords = chunkZ + random.nextInt(16);
            new WorldGenMinable(ModBlocks.CaesiumOreBlock,3).generate(world, random, Xcoords, Ycoords, Zcoords);
        }
    }
