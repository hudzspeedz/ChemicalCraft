 ...
 */
public class RubidiumOreGeneraion implements IWorldGenerator {
    @Override
    ...
    private void generateSurface(World world, Random random, int chunkX,int chunkZ)
    {
        for(int K = 0; K < 12; K++){
            ...
            int Ycoords = random.nextInt(42);
            int Zcoords = chunkZ + random.nextInt(16);
            new WorldGenMinable(ModBlocks.RubidiumOreBlock,4).generate(world, random, Xcoords, Ycoords, Zcoords);
        }
    }
